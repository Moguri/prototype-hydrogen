...
class GameUI:
    ...
    def __init__(self):
        for idx,root in enumerate(self._roots):
            setattr(self, root[0], dppgui.DPPFrame(
        ...
        dppgui.global_theme = dppgui.DPPTheme()
        dppgui.global_theme.props = {
            'title_bg': {
                'image': 'landscape.png',
...
class MainUI(GameUI):
    ...
    def setup_status(self, mechs, back_cb=None, back_args=[]):
        ...
        if back_cb:
            self._back_btn = dppgui.DPPButton(
                parent=self.root,
                command=back_cb,
...
class CombatUI(GameUI):
    ...
    def _create_pc_frame(self, n):
        ...
        frame.attacklabel = dppgui.DPPLabel(
            parent=frame,
            text='',
    ...
    def setup_selections(self, title, selections, select_cb):
        ...
        self._selection_frame = dppgui.DPPFrame(
            parent=self.root,
            frame_color=(0.8, 0.8, 0.8, 0.5),
